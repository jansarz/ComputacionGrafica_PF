...
void CFiguras::plano(float altura, float largo, GLuint text) {
	glBindTexture(GL_TEXTURE_2D, text);   // choose the texture to use.
	GLfloat vertice[4][3] = {
				{0.0*largo ,0.0*altura, 0.0},    //Coordenadas Vértice 1 V1
				{1.0*largo ,0.0*altura , 0.0},    //Coordenadas Vértice 2 V2
				{1.0*largo ,1.0*altura , 0.0},    //Coordenadas Vértice 3 V3
				{0.0*largo ,1.0*altura , 0.0},    //Coordenadas Vértice 4 V4
	};
...
void CFiguras::prisma2 (float altura, float largo, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prisma3(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3, GLuint text4)  //Funcion creacion prisma
{
...
void CFiguras::prisma_anun (GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glNormal3f( 0.0f,1.0f, 0.0f);
			...
			glTexCoord2f(text_der, 0.04f); glVertex3fv(vertice[5]);
			glTexCoord2f(text_izq, 0.04f); glVertex3fv(vertice[6]);
