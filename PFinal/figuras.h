...
class CFiguras
{
	...
	void plano(float altura, float largo, GLuint text);//Funcíon creacion plano
	...
	void prisma3(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3, GLuint text4);
